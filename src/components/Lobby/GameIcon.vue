...
<template>
  <div>
    ...
    <div v-else-if="props.status === STATUS_ICON.SNAKE" class="game-icon" :class="[STATUS_ICON.SNAKE]">
...
.game-icon.racing {
  ...
  .content {
    ...
    .auto-light-1 {
      ...
      background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0), rgba(244, 255, 241, 0.15), rgba(255, 255, 255, 0));
      position: relative;
      top: -110px;
      left: -55px;
