...
const initAnimations = () => {
  ...
  Animation.addClass(
    "nvbarBlock",
    "animation-block-down",
    ANIMATION_TIMING.NAVBAR
  );
  Animation.addClass(
    "mainFooter",
    "animation-block-down",
    ANIMATION_TIMING.FOOTER
  );
...
const scrollAnim = {
  ...
  top350_hide() {
    ...
    gameBlocks.forEach((block) => {
      ...
      console.log('block',block )
      $(`#${block}`).children().each(function(i, el) {
          ...
          <div class="content-block">
            <div id="logoBox" class="logo">
              <div class="logoBox">
                ...
                <span id="appyWord" class="appyWord self" data-splitting
                  >APPY</span
                >
                <span id="fatWord" class="fatWord self" data-splitting
                  >FAT</span
                >
                <span id="yoyoWord" class="yoyoWord self" data-splitting>
                  yoyo
                </span>
              </div>
      ...
      <div class="main">
        ...
        <div class="header-left">
          <div class="contactBlock">
            <div id="contactBlock" class="content-block">
              <span class="item setting-text"> CONTACT </span>
              <span id="buttonFacebook" class="item button-facebook">
                FACEBOOK
              </span>
