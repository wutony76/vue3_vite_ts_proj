...
import GameBase from '@/views/GameBaseElectronic.vue'
...
const state = reactive({
  title: 'Tetriminos',
  time: 'TONY.WORKS@2025.04',
  game: {
    footer: 'TETRIMINOS.GAME @ 2025.04'
  },
  // __game.args.settings__
  args: {
...
// @import "../assets/css/game/animations.scss";</style>